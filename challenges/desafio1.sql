...
CREATE TABLE SpotifyClone.plans(
    ...
    plan_name ENUM('gratuito', 'universitario', 'pessoal', 'familiar') NOT NULL,
    plan_price DECIMAL(3, 2) NOT NULL DEFAULT 0.00
) engine = InnoDB;
...
VALUES
  ...
  ('pessoal', '6.99'),
  ('familiar', '7.99');
INSERT INTO SpotifyClone.users (user_name, user_age, plan_id, data_sign)
VALUES
